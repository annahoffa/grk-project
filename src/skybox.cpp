...
void initializeSkybox()
{
    ...
    // load textures
    // -------------
    unsigned int cubeTexture = loadTexture(FileSystem::getPath("resources/textures/container.jpg").c_str());    // to jest tylko obiekt, jaki renderuja sb w tutorialu we wnetrzu skyboxa
